...
When an arm/disarm command succeeds, the alarm entity updates its state immediately in Home Assistant and exposes `Last Command`, `Last Command State`, and `Last Command At` attributes.
